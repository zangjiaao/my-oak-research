"""BBC intercept handlers."""

from fastapi import HTTPException

from core.config import BBC_INTERCEPT_INTENTS, SCRIPT_REGISTRY
...
async def run_bbc_intent(request: FetchRequest, intent_type: str) -> list[CleanItem]:
    ...
    if normalized_intent not in BBC_INTERCEPT_INTENTS:
