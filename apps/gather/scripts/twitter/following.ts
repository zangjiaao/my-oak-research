/* @meta
{
  ...
  "description": "获取 twitter 的 following 数据",
  "domain": "x.com",
  "args": {
    "username": {
      "required": true,
  ...
  "readOnly": true,
  "example": "bb-browser site twitter/following openai 50"
}
*/
      ...
      try {
        ...
        const reqUrl =
          typeof requestLike === 'string'
            ? requestLike
            : requestLike && typeof (requestLike as any).url === 'string'
              ? (requestLike as any).url
              : '';
